...
- <img src="https://thdlrt.oss-cn-beijing.aliyuncs.com/image-20231105174629282.png" alt="image-20231105174629282" style="zoom:33%;" />
...
- <img src="https://thdlrt.oss-cn-beijing.aliyuncs.com/image-20231105181300013.png" alt="image-20231105181300013" style="zoom:33%;" />
  ...
  - 有符号$OF=SF$表示大于；无符号$CF=0$

- 溢出分类

  - 减法
    - <img src="https://thdlrt.oss-cn-beijing.aliyuncs.com/image-20231105181509957.png" alt="image-20231105181509957" style="zoom:33%;" />
...
- <img src="https://thdlrt.oss-cn-beijing.aliyuncs.com/image-20231105185529821.png" alt="image-20231105185529821" style="zoom:33%;" />
- 硬件实现
...
- 用于带符号整数的乘法运算，因为$[x*y]_补!=[x]_补*[y]_补$
  ...
  - 下标从低位到高位递增，$y_{-1}=0$
    ...
    <img src="https://thdlrt.oss-cn-beijing.aliyuncs.com/image-20231105213335601.png" alt="image-20231105213335601" style="zoom:33%;" />
